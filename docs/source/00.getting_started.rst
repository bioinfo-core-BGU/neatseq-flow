...
6. Execute **NeatSeq-Flow**::
    ...
    neatseq_flow.py                                                          \
        --sample_file $CONDA_PREFIX/Workflows/Sample_sets/PE_tabular.nsfs    \
        --param_file  $CONDA_PREFIX/Workflows/mapping.yaml                   \
        --message     "an informative message"
...
.. Attention:: See the `tutorial`_ for a full example of how to use **NeatSeq-Flow**
