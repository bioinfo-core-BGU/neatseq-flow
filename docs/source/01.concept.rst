...
4. Execute **NeatSeq-Flow** (see :ref:`executing NeatSeq-Flow <Execution_section>`) to create the workflow scripts.
5. Execute the workflow scripts by executing the ``scripts/00.pipe.commands.csh`` script.
