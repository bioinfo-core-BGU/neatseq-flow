        ...
        for sample in self.sample_data["samples"]:      # Getting list of samples out of samples_hash
            ...
            if "view" in self.params.keys():
                ...
                if tobam:
                    ...
                    continue
                self.script += self.add_exit_status_check(comment = "samtools view failed")
            ...
            if "sort" in self.params.keys():
                ...
                self.script += self.add_exit_status_check(comment = "samtools sort failed")
            ...
            if "index" in self.params.keys():
                ...
                self.script += self.add_exit_status_check(comment = "samtools index failed")
            ...
            if "flagstat" in self.params.keys():
                ...
                self.script += self.add_exit_status_check(comment = "samtools flagstat failed")
            ...
            if "stats" in self.params.keys():
                ...
                self.script += self.add_exit_status_check(comment = "samtools stats failed")
            ...
            if "idxstats" in self.params.keys():
                ...
                self.script += self.add_exit_status_check(comment = "samtools idxstats failed")
            ...
            for type in (set(self.params.keys()) & set(["fasta","fastq"])):
                ...
                self.script += self.add_exit_status_check(comment = "samtools fastq/fasta failed")
